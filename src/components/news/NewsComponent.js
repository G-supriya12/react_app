...
function NewsComponent() 
{
  ...
  useEffect(() => {
    fetch("videoData.json")`https://newsapi.org/v2/everything?q=tesla&from=2024-06-05&sortBy=publishedAt&apiKey=4dd91b22050847fea27f058ba4dd71e2`
      .then(res => res.json())
      .then(data => setNews(data))
      .catch(err => console.err(" Problem with fetching data!!", error))
  }, []);
  return (
